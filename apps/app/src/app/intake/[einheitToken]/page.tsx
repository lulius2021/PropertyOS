    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
        <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-lg">
          ...
          <h2 className="mb-2 text-2xl font-bold text-gray-900">Meldung eingereicht!</h2>
          <p className="text-gray-600">Ihre Meldung wurde erfolgreich übermittelt.</p>
          <p className="mt-2 text-sm text-gray-500">Ticket-ID: <code className="rounded bg-gray-100 px-2 py-1 text-xs">{submitted.slice(-8).toUpperCase()}</code></p>
          <p className="mt-4 text-sm text-gray-500">Wir werden uns schnellstmöglich um Ihr Anliegen kümmern.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-lg rounded-2xl bg-white p-8 shadow-lg">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Schadenmeldung / Anfrage</h1>
          <p className="mt-1 text-gray-500">Melden Sie uns ein Problem oder eine Anfrage</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-gray-700">Art der Meldung</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700">Ihr Name (optional)</label>
